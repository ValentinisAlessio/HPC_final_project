...
#SBATCH --output=bcast-bintree-core.out
#SBATCH --error=bcast-bintree-core.err
#SBATCH --nodes=2
#SBATCH --ntasks=256
#SBATCH -p EPYC
#SBATCH --exclusive
...
csv_file="results_def/bcast_bintree_results_wu_core.csv"
...
for np in {1..256}; do
    ...
    mpirun -np $np --map-by core --mca coll_tuned_use_dynamic_rules true --mca coll_tuned_bcast_algorithm 5 $src_path/osu_bcast -m 1024 -x 100 -i 10000 |\
