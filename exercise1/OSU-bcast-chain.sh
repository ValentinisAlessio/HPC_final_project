...
csv_file="results/bcast_chain_results_wu.csv"
...
for mapping in $map_values; do
    ...
    for np in $np_values; do
        ...
        mpirun -np $np --map-by $mapping --mca coll_tuned_use_dynamic_rules true --mca coll_tuned_bcast_algorithm 2 $src_path/osu_bcast -i 100 -x 10000 |\
